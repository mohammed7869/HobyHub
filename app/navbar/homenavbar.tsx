            ...
            <div className="hidden md:block">
                <div className="w-full h-[67.88px] bg-[#003161] border-b border-[#dee2e6] justify-between flex">
                    ...
                    <div className="bg-white/10 rounded-lg px-4 gap-4 py-2 flex ">
                        <div className="w-[47.41px] pl-[3.17px] pr-[3.29px] justify-center gap-[3px] items-center inline-flex">
                        ...
                        <div className="w-auto] h-[44.38px] p-[3.19px] bg-white rounded-md shadow-[0px_8px_16px_0px_rgba(0,0,0,0.15)] justify-center items-start gap-[0px] inline-flex">
